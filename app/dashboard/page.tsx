...
const NAV: [string, string][] = [['/dashboard', 'Desk'], ['/live', '⚡ Live'], ['/growth', 'Growth'], ['/sleeves', 'Sleeves'], ['/portfolio', 'Portfolio'], ['/trades', 'Trades'], ['/learning', 'Learning'], ['/discovery', '🔭 Discovery'], ['/backtest', '🧪 Backtest'], ['/fix', '🔧 Fix'], ['/settings', 'Settings']]
